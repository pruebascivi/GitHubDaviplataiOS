...
public class NotificacionesPushPageObjects {
    ...
    public static final String BOTON_CAMPANA_NOTIFICACIONES = "";
    public static final String NOTIFICACION_DE_TRANSACCION_DAVIVIENDA = "";
    ...
    public static final String MOVIMIENTO_HOME_PASO_PLATA ="";
    public static final String MENSAJE_RECARGA_DAVIVIENDA = ""; 
    ...
    public static final String MENSAJE_TRANSFERENCIA_DAVIPLATA = ""; 
    public static final String MENSAJE_COMPRA_TIENDA_VIRTUAL_DAVIPLATA = ""; 
    public static final String BOTON_COMPRAS_EN_TIENDA_VIRTUAL = "";
    public static final String MENSAJE_COMPRA_PSE_DAVIPLATA = ""; 
